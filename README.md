...
# Objectives
To study the impact of parents’ education level on students’ academic performance.
To analyze the distribution of students across different ethnic groups.
To understand the variation in scores for Math, Reading, and Writing subjects.
To represent insights using effective data visualization techniques.
